...
window.onload = function () {
  ...
  FamilyTree.templates.john_male.died = `<foreignobject class="node" x="80" y="-5" width="30" height="30"><img src="./assets/allahummaghfirlahu.png" width="30" height="30"></foreignobject>`;
  FamilyTree.templates.john_female.died = `<foreignobject class="node" x="80" y="-5" width="30" height="30"><img src="./assets/allahummaghfirlahu.png" width="30" height="30"></foreignobject>`;
  ...
  FamilyTree.templates.john.defs = `<g transform="matrix(0.05,0,0,0.05,-12,-9)" id="heart"><path fill="#FF251B" d="M438.482,58.61c-24.7-26.549-59.311-41.655-95.573-41.711c-36.291,0.042-70.938,15.14-95.676,41.694l-8.431,8.909  l-8.431-8.909C181.284,5.762,98.663,2.728,45.832,51.815c-2.341,2.176-4.602,4.436-6.778,6.778 c-52.072,56.166-52.072,142.968,0,199.134l187.358,197.581c6.482,6.843,17.284,7.136,24.127,0.654 c0.224-0.212,0.442-0.43,0.654-0.654l187.29-197.581C490.551,201.567,490.551,114.77,438.482,58.61z"/></g>`;

  //FamilyTree.templates.john_male.node = '<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill="#81e9ff" rx="60" ry="60"></rect>';
  //FamilyTree.templates.john_female.node = '<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill="#ffc0cb" rx="60" ry="60"></rect>';
